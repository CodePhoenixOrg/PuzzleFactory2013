...
--
-- Client: mysql:3306
-- Généré le: Lun 04 Février 2019 à 08:24
...
--
CREATE DATABASE IF NOT EXISTS `webfactory` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `webfactory`;
...
--
-- Création: Mer 23 Janvier 2019 à 22:16
--
...
--
-- Contenu de la table `bugreport`
--

INSERT INTO `bugreport` (`br_id`, `br_title`, `br_text`, `br_importance`, `br_status`, `br_date`, `br_time`, `mbr_id`) VALUES
(1, 'Petits bugs', 'Plein de petits bugs', 1, 'fixé', '2019-01-13 00:00:00', NULL, 1);
...
(15, 'mkmenu', 'Créer un menu', 'Créer une nouvelle entrée de menu afin d''attacher un script externe ou une landing page', 'Create a menu', 'Create a new menu item', '', ''),
...
(45, 'images', 'Images', 'Liste des images', '', '', NULL, NULL),
(47, 'mainmenu', 'Menu principal', 'Menu principal', 'Main menu', 'Main menu', NULL, NULL);
...
INSERT INTO `images` (`im_id`, `im_name`, `im_dir`, `im_url`, `im_site`) VALUES
(1, 'Dummy', 'CURRENT_DIRECTOR', '/images/logo1.png', 1);
...
--
-- Création: Mer 23 Janvier 2019 à 22:16
-- Dernière modification: Dim 27 Janvier 2019 à 10:24
--
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `di_name` varchar(8) DEFAULT NULL,
  `grp_group` varchar(13) DEFAULT 'user',
  `me_charset` varchar(8) DEFAULT 'utf8',
  PRIMARY KEY (`me_id`)
...
(17, '1', 'pages', 17, 1, 'home', '0', 'utf8'),
(18, '1', 'page', 18, 0, 'menus', '0', 'utf8'),
(19, '2', 'page', 19, 1, 'pages', '0', 'utf8'),
(20, '2', 'page', 20, 3, 'blocks', '0', 'utf8'),
(21, '1', 'page', 21, 1, 'dictiona', '0', 'utf8'),
(22, '2', 'page', 22, 1, 'applicat', '0', 'utf8'),
(23, '0', 'page', 23, 0, 'forums', 'user', 'utf8'),
...
(54, '0', 'page', 58, 0, 'images', 'user', 'utf8');
...
INSERT INTO `queries` (`qy_id`, `qy_name`, `qy_string`, `qy_database`) VALUES
(1, 'Select All', 'SELECT * FROM members', 1);
...
INSERT INTO `todo` (`td_id`, `td_title`, `td_text`, `td_priority`, `td_expiry`, `td_status`, `td_date`, `td_time`, `mbr_id`, `mbr_id2`) VALUES
(1, 'Aller chercher mes lunettes', 'Il faut absolument que j''aille chercher ma première paire de lunettes', 1, '2019-02-13 14:44:16', 'à faire', '2019-01-13 00:00:00', NULL, 1, NULL);
...
--
-- Structure de la table `v_menus`
--
-- Création: Mer 23 Janvier 2019 à 22:16
--

DROP TABLE IF EXISTS `v_menus`;
CREATE TABLE IF NOT EXISTS `v_menus` (
...
--
-- Contenu de la table `v_menus`
--

INSERT INTO `v_menus` (`vm_id`, `me_id`, `pa_id`, `me_target`, `me_level`, `di_name`, `pa_filename`, `di_fr_short`, `di_fr_long`, `di_en_short`, `di_en_long`) VALUES
(1, 17, 17, 'pages', '2', 'home', 'mkmain.php', 'Accueil', 'Page d''accueil', 'Home', 'Home page'),
(2, 18, 19, 'page', '1', 'pages', 'pages.php', 'Pages', 'Liste des pages', 'Pages', 'List of pages'),
(3, 19, 19, 'page', '2', 'pages', 'pages.php', 'Pages', 'Liste des pages', 'Pages', 'List of pages'),
(4, 20, 20, 'page', '2', 'blocks', 'blocks.php', 'Blocs', 'Liste des blocs', 'Blocks', 'List of blocks'),
(5, 21, 21, 'page', '1', 'dictiona', 'dictionary.php', 'Dictionnaire', '', 'Dictionary', ''),
(6, 22, 22, 'page', '2', 'applicat', 'applications.php', 'Applications', 'Liste des applications', 'Applications', 'List of applications'),
(7, 23, 23, 'page', '0', 'forums', 'forums.php', 'Forums', 'Forums disponibles', 'Forums', 'Available forums'),
(8, 24, 24, 'page', '1', 'changelo', 'changelog.php', 'Changements', 'Notes de changements', 'Changes', 'Change log'),
(9, 25, 25, 'page', '1', 'todo', 'todo.php', 'A faire', 'Liste des tâches', 'To do', 'Tasks to do'),
(10, 26, 26, 'page', '1', 'bugrepor', 'bugreport.php', 'Bugs', 'Rapport de bugs', 'Bugs', 'Bug reports'),
(11, 27, 27, 'page', '2', 'groups', 'groups.php', 'Groupes', 'Liste des groupes', 'Groups', 'List of groups'),
(12, 29, 29, 'page', '0', 'mkscript', 'mkscript.php', 'Créer un script', 'Créer un script à partir d''une table', 'Create a script', 'Create a script from a table'),
(13, 30, 30, 'page', '0', 'mkmenu', 'mkmenu.php', 'Créer un menu', 'Créer une nouvelle entrée de menu afin d''attacher un script externe ou une landing page', 'Create a menu', 'Create a new menu item'),
(14, 31, 31, 'page', '0', 'mkblock', 'mkblock.php', 'Créer un bloc', 'Créer un nouveau bloc', 'Create a block', 'Create a new block'),
(15, 32, 32, 'page', '0', 'mkfields', 'mkfields.php', 'Champs', 'Champs de la table', 'Fields', 'Table fields'),
(16, 33, 33, 'page', '0', 'mkfile', 'mkfile.php', 'Fichier', 'Création du fichier', 'File', 'Creation of the file');
