	...
	function pz_move(o,x,y){
		...
		if(PZ_CURSOR.direction==PZ_HORIZONTAL_SCROLL)
			PZ_OBJECT.scrollXByPercent();
		else if(PZ_CURSOR.direction==PZ_VERTICAL_SCROLL)
			PZ_OBJECT.scrollYByPercent();
	}
	...
	function pz_moveByPercent(){
		...
		if(PZ_CURSOR.direction==PZ_HORIZONTAL_SCROLL) {
			...
			cursorLeft=PZ_CURSOR.scroller.offsetLeft+13+PZ_OBJECT.cursorXPos*(PZ_CURSOR.scroller.offsetWidth-26-PZ_CURSOR.width);
			...
			cursorTop=PZ_CURSOR.scroller.offsetTop+13+PZ_OBJECT.cursorYPos*(PZ_CURSOR.scroller.offsetHeight-26-PZ_CURSOR.height);
	...
	function pz_mouseMove(){
		...
		if (PZ_CURSOR.style) {
			if(PZ_CURSOR.direction==PZ_HORIZONTAL_SCROLL) {
				...
				PZ_OBJECT.cursorXPos=(cursorLeft-lowerLimit)/(PZ_CURSOR.scroller.offsetWidth-26-PZ_CURSOR.width);
				...
				PZ_OBJECT.cursorYPos=(cursorTop-lowerLimit)/(PZ_CURSOR.scroller.offsetHeight-26-PZ_CURSOR.height);
